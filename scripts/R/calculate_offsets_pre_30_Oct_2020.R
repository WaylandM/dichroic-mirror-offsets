...
# get list of files
filelist <- read.csv("E:/Matt/dichroic-mirror-offsets-master/tables/dm_offset_file_list_pre_20201030.csv", stringsAsFactors = F)
...
saveRDS(results, file="E:/Matt/dichroic-mirror-offsets-master/tables/results_pre_20201030.RDS")
...
write.csv(offsetResults, "E:/Matt/dichroic-mirror-offsets-master/tables/offsetResults_pre_20201030.csv", row.names=F, quote=F)
...
write.csv(offsetTable, "E:/Matt/dichroic-mirror-offsets-master/tables/offsetTable_pre_20201030.csv", row.names=F, quote=F)
