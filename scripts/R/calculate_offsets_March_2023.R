...
# get list of files
filelist <- read.csv("E:/Matt/dichroic-mirror-offsets-master/tables/March_2023_filelist.csv", stringsAsFactors = F)
...
write.csv(offsetResults, "E:/Matt/dichroic-mirror-offsets-master/tables/offsetResults_March_2023.csv", row.names=F, quote=F)
...
write.csv(offsetTable, "E:/Matt/dichroic-mirror-offsets-master/tables/offsetTable_March_2023.csv", row.names=F, quote=F)
