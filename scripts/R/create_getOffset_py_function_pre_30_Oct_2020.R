...
# python script name
py_script_filename <- "E:/Matt/dichroic-mirror-offsets-master/scripts/py/lateral_offset_lookup_pre_20201030.py"

# read table containing lateral offset data
offsetTable <- read.csv("E:/Matt/dichroic-mirror-offsets-master/tables/offsetTable_pre_20201030.csv", stringsAsFactors = F)
