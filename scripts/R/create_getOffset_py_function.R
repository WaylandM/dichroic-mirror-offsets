...
# python script name
py_script_filename <- "/Users/matt/Cam_Dropbox/vm_share/olympus/scripts/py/lateral_offset_lookup.py"

# read table containing lateral offset data
offsetTable <- read.csv("/Users/matt/Cam_Dropbox/vm_share/olympus/DM_offset_data/offsetTable_20200102.csv", stringsAsFactors = F)
